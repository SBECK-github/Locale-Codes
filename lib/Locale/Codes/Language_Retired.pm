...
$Locale::Codes::Retired{'language'}{'alpha-3'}{'name'} = {
   ...
   q(enwan (edu state)) => [ q(env), q(Enwan (Edu State)) ],
   q(fang) => [ q(fan), q(Fang) ],
   ...
   q(judeo-tunisian arabic) => [ q(ajt), q(Judeo-Tunisian Arabic) ],
   ...
   q(northwestern tamang) => [ q(tmk), q(Northwestern Tamang) ],
