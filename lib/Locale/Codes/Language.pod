...
Locale::Codes::Language - Locale-Codes module for dealing with language code sets
...
This module provides access to standard codes of type language.

Please refer to the L<Locale::Codes::Types> document for a description
of the code sets available for this type.
